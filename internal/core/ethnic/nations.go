// Code moved from the original constants table; edit overrides via Resolver, not here.

package ethnic

// DefaultNationTable maps FM three-letter nation codes to ethnic groups.
// It must never be mutated at runtime; use NewResolver for overrides.
var DefaultNationTable = map[string]Ethnic{
