...
type Version struct {
	// Year is the canonical key stored in profiles, e.g. "2024" or "2026".
	Year string
...
// so it is deliberately absent. FM26 (2026) is assumed to keep the FM24 "r-"
// prefix; if a user reports otherwise, adjust IDPrefix here only.
var Known = []Version{
	{Year: "2026", Label: "FM26", IDPrefix: "r-"},
